...
const EMAIL = "hola@g1.dev";
const INSTAGRAM = "https://instagram.com/g1.dev";
const LINKEDIN = "https://linkedin.com/company/g1dev";
            ...
            <div className="flex flex-col gap-6 h-full">
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  {/* WhatsApp */}
                  <a
                    href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hola! Me interesa saber más sobre sus servicios.`}
                    target="_blank"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">+54 11 0000-0000</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">@g1.dev</div>
                    </div>
                  </a>
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    id="linkedin-link"
                    className="group flex items-center gap-4 p-4 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-blue-400/30 hover:bg-blue-400/[0.04] transition-all duration-300"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">G1 Software</div>
                    </div>
                  </a>
                </div>
              </div>
